      ...
      <div className="pt-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
          <div className="windows-card p-12 md:p-16 bg-gradient-to-br from-windows-dark-accent/30 via-windows-dark-accent/20 to-windows-dark-accent/10 text-center mb-12 md:mb-16">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">TechSource Hardware</h1>
            <p className="text-xl md:text-2xl text-windows-dark-text-secondary max-w-3xl mx-auto">
              Certified pre-owned and new enterprise hardware from trusted suppliers. Servers, workstations, and networking equipment.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-12 md:mb-16">
            <div className="windows-card p-6 md:p-8">
              <h3 className="text-2xl font-bold text-white mb-4">Enterprise Servers</h3>
              <p className="text-windows-dark-text-secondary mb-4">
                High-performance server hardware from leading manufacturers for mission-critical applications.
              </p>
              <ul className="space-y-2 text-windows-dark-text-secondary">
                <li>• Rack servers</li>
                <li>• Tower servers</li>
                <li>• Blade servers</li>
                <li>• Server accessories</li>
              </ul>
            </div>
            ...
            <div className="windows-card p-6 md:p-8">
              ...
              <p className="text-windows-dark-text-secondary mb-4">
                Powerful workstations for demanding professional applications and creative workflows.
              </p>
              <ul className="space-y-2 text-windows-dark-text-secondary">
            ...
            <div className="windows-card p-6 md:p-8">
              ...
              <p className="text-windows-dark-text-secondary mb-4">
                Enterprise networking hardware including switches, routers, and wireless access points.
              </p>
              <ul className="space-y-2 text-windows-dark-text-secondary">
                <li>• Network switches</li>
                <li>• Routers and firewalls</li>
                <li>• Wireless access points</li>
                <li>• Network cables and accessories</li>
              </ul>
            </div>

            <div className="windows-card p-6 md:p-8">
              <h3 className="text-2xl font-bold text-white mb-4">Storage Solutions</h3>
              <p className="text-windows-dark-text-secondary mb-4">
                Enterprise storage systems including NAS, SAN, and backup storage solutions.
              </p>
              <ul className="space-y-2 text-windows-dark-text-secondary">
            ...
            <div className="windows-card p-6 md:p-8">
              <h3 className="text-2xl font-bold text-white mb-4">Certified Pre-Owned</h3>
              <p className="text-windows-dark-text-secondary mb-4">
                Quality-tested pre-owned hardware with warranties and support at reduced costs.
              </p>
              <ul className="space-y-2 text-windows-dark-text-secondary">
            ...
            <div className="windows-card p-6 md:p-8">
              ...
              <p className="text-windows-dark-text-secondary mb-4">
                Comprehensive support services including installation, configuration, and maintenance.
              </p>
              <ul className="space-y-2 text-windows-dark-text-secondary">
          ...
          <div className="windows-card p-12 md:p-16 bg-gradient-to-br from-windows-dark-accent/20 to-windows-dark-accent/5 text-center">
            ...
            <p className="text-windows-dark-text-secondary mb-10 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
              Browse our selection of enterprise hardware or contact us for custom recommendations.
            </p>
